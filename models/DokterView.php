 ...
 * Page class
 */
class DokterView extends Dokter
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "dokterlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "dokterlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "dokterlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
