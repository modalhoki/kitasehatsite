 ...
 * Page class
 */
class WebusersView extends Webusers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WebusersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "webuserslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "webuserslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "webuserslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
