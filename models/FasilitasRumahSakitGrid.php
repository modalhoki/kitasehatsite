 ...
 * Page class
 */
class FasilitasRumahSakitGrid extends FasilitasRumahSakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitasRumahSakitGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "ffasilitas_rumah_sakitgrid";
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_fasilitas_id")) {
