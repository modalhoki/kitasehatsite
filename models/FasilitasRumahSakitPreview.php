 ...
 * Page class
 */
class FasilitasRumahSakitPreview extends FasilitasRumahSakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitasRumahSakitPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "rumah_sakit") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=rumah_sakit&" . GetForeignKeyUrl("fk_id", $this->rumah_sakit_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "rumah_sakit") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->rumah_sakit_id->setQueryStringValue($val);
            }
        }
    }
