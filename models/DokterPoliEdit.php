 ...
 * Page class
 */
class DokterPoliEdit extends DokterPoli
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DokterPoliEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // fasilitas_rs_id
            $this->fasilitas_rs_id->setDbValueDef($rsnew, $this->fasilitas_rs_id->CurrentValue, 0, $this->fasilitas_rs_id->ReadOnly);

            // jam_praktik
            $this->jam_praktik->setDbValueDef($rsnew, $this->jam_praktik->CurrentValue, "", $this->jam_praktik->ReadOnly);
