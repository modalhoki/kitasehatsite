...
class AntreanUmumRs extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // waktu
        $this->waktu = new DbField('antrean_umum_rs', 'antrean_umum_rs', 'x_waktu', 'waktu', '`waktu`', CastDateFieldForLike("`waktu`", 1, "DB"), 135, 19, 1, false, '`waktu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("antrean_umum.*, (SELECT webusers.username FROM webusers WHERE webusers.id = webusers_id) AS `Petugas`");
    }
