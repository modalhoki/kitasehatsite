 ...
 * Page class
 */
class PraktikPoliGrid extends PraktikPoli
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PraktikPoliGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpraktik_poligrid";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // hari_praktik
            $this->hari_praktik->setDbValueDef($rsnew, $this->hari_praktik->CurrentValue, "", $this->hari_praktik->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "fasilitas_rumah_sakit") {
            $this->fasilitas_rumah_sakit_id->CurrentValue = $this->fasilitas_rumah_sakit_id->getSessionValue();
        }
        if ($this->getCurrentMasterTable() == "dokter") {
            $this->dokter_id->CurrentValue = $this->dokter_id->getSessionValue();
        }
        $conn = $this->getConnection();
