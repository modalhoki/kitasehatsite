 ...
 * Page class
 */
class RumahSakitDelete extends RumahSakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RumahSakitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("rumahsakitlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("rumahsakitlist"); // Return to list
                return;
            }
        }
