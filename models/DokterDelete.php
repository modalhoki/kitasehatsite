 ...
 * Page class
 */
class DokterDelete extends Dokter
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DokterDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("dokterlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("dokterlist"); // Return to list
                return;
            }
        }
