 ...
 * Page class
 */
class DataDurasiDelete extends DataDurasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataDurasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("datadurasilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("datadurasilist"); // Return to list
                return;
            }
        }
