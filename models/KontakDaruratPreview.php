 ...
 * Page class
 */
class KontakDaruratPreview extends KontakDarurat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KontakDaruratPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pasien") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pasien&" . GetForeignKeyUrl("fk_id", $this->pasien_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "pasien") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->pasien_id->setQueryStringValue($val);
            }
        }
    }
