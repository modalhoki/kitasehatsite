 ...
 * Page class
 */
class AntreanBpjsView extends AntreanBpjs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntreanBpjsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "antreanbpjslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "antreanbpjslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "antreanbpjslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
