...
/**
 * Table class for data_durasi
 */
class DataDurasi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'data_durasi';
        $this->TableName = 'data_durasi';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`data_durasi`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('data_durasi', 'data_durasi', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        $this->Fields['waktu_edit'] = &$this->waktu_edit;

        // durasi
        $this->durasi = new DbField('data_durasi', 'data_durasi', 'x_durasi', 'durasi', '`durasi`', '`durasi`', 3, 11, -1, false, '`durasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`data_durasi`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("datadurasilist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "datadurasiedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "datadurasiadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DataDurasiView";
            case Config("API_ADD_ACTION"):
                return "DataDurasiAdd";
            case Config("API_EDIT_ACTION"):
                return "DataDurasiEdit";
            case Config("API_DELETE_ACTION"):
                return "DataDurasiDelete";
            case Config("API_LIST_ACTION"):
                return "DataDurasiList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("datadurasiview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("datadurasiview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "datadurasiadd?" . $this->getUrlParm($parm);
        } else {
            $url = "datadurasiadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("datadurasiedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("datadurasiadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("datadurasidelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // waktu_edit
        $this->waktu_edit->LinkCustomAttributes = "";
        $this->waktu_edit->HrefValue = "";
        $this->waktu_edit->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->waktu_daftar->EditValue = FormatDateTime($this->waktu_daftar->CurrentValue, 8);
        $this->waktu_daftar->PlaceHolder = RemoveHtml($this->waktu_daftar->caption());

        // waktu_edit
        $this->waktu_edit->EditAttrs["class"] = "form-control";
        $this->waktu_edit->EditCustomAttributes = "";
        $this->waktu_edit->EditValue = FormatDateTime($this->waktu_edit->CurrentValue, 8);
        $this->waktu_edit->PlaceHolder = RemoveHtml($this->waktu_edit->caption());
