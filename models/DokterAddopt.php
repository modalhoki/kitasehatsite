 ...
 * Page class
 */
class DokterAddopt extends Dokter
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DokterAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->nama_dokter->IsDetailKey) {
            $this->nama_dokter->setFormValue(ConvertFromUtf8($val));
        }
        ...
        if (!$this->webusers_id->IsDetailKey) {
            $this->webusers_id->setFormValue(ConvertFromUtf8($val));
        }
    ...
    {
        global $CurrentForm;
        $this->nama_dokter->CurrentValue = ConvertToUtf8($this->nama_dokter->FormValue);
        $this->webusers_id->CurrentValue = ConvertToUtf8($this->webusers_id->FormValue);
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("dokterlist"), "", $this->TableVar, true);
        $pageId = "addopt";
