 ...
 * Page class
 */
class AntreanBpjsSearch extends AntreanBpjs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntreanBpjsSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "antreanbpjslist" . "?" . $srchStr;
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->rumah_sakit_id->AdvancedSearch->SearchValue)) {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("antreanbpjslist"), "", $this->TableVar, true);
        $pageId = "search";
