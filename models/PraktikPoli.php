...
/**
 * Table class for praktik_poli
 */
class PraktikPoli extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'praktik_poli';
        $this->TableName = 'praktik_poli';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`praktik_poli`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->fasilitas_rumah_sakit_id->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->fasilitas_rumah_sakit_id->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->fasilitas_rumah_sakit_id->Lookup = new Lookup('fasilitas_rumah_sakit_id', 'fasilitas_rumah_sakit', false, 'id', ["rumah_sakit_id","fasilitas_id","",""], [], [], [], [], [], [], '', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`praktik_poli`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("praktikpolilist");
    }
    ...
    {
        global $Language;
        if ($pageName == "praktikpoliview") {
            return $Language->phrase("View");
        } elseif ($pageName == "praktikpoliedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "praktikpoliadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PraktikPoliView";
            case Config("API_ADD_ACTION"):
                return "PraktikPoliAdd";
            case Config("API_EDIT_ACTION"):
                return "PraktikPoliEdit";
            case Config("API_DELETE_ACTION"):
                return "PraktikPoliDelete";
            case Config("API_LIST_ACTION"):
                return "PraktikPoliList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("praktikpoliview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("praktikpoliview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "praktikpoliadd?" . $this->getUrlParm($parm);
        } else {
            $url = "praktikpoliadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("praktikpoliedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("praktikpoliadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("praktikpolidelete", $this->getUrlParm());
    }
