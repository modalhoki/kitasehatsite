...
/**
 * Table class for webusers
 */
class Webusers extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'webusers';
        $this->TableName = 'webusers';
        ...
        // id
        $this->id = new DbField('webusers', 'webusers', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // username
        $this->_username = new DbField('webusers', 'webusers', 'x__username', 'username', '`username`', '`username`', 200, 255, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // password
        $this->_password = new DbField('webusers', 'webusers', 'x__password', 'password', '`password`', '`password`', 200, 255, -1, false, '`password`', false, false, false, 'FORMATTED TEXT', 'PASSWORD');
        ...
        // role
        $this->role = new DbField('webusers', 'webusers', 'x_role', 'role', '`role`', '`role`', 3, 11, -1, false, '`role`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // rumah_sakit_id
        $this->rumah_sakit_id = new DbField('webusers', 'webusers', 'x_rumah_sakit_id', 'rumah_sakit_id', '`rumah_sakit_id`', '`rumah_sakit_id`', 20, 20, -1, false, '`rumah_sakit_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->administrator_rumah_sakit = new DbField('webusers', 'webusers', 'x_administrator_rumah_sakit', 'administrator_rumah_sakit', '`administrator_rumah_sakit`', '`administrator_rumah_sakit`', 20, 20, -1, false, '`administrator_rumah_sakit`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->administrator_rumah_sakit->Lookup = new Lookup('administrator_rumah_sakit', 'webusers', false, 'id', ["username","","",""], [], [], [], [], [], [], '', '');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("webuserslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "webusersedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "webusersadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("webusersview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("webusersview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "webusersadd?" . $this->getUrlParm($parm);
        } else {
            $url = "webusersadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("webusersedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("webusersadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("webusersdelete", $this->getUrlParm());
    }
