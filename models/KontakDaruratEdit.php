 ...
 * Page class
 */
class KontakDaruratEdit extends KontakDarurat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KontakDaruratEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("kontakdaruratlist"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "kontakdaruratlist") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("kontakdaruratlist"), "", $this->TableVar, true);
        $pageId = "edit";
