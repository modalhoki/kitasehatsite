 ...
 * Page class
 */
class FasilitasAddopt extends Fasilitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitasAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->nama_layanan->IsDetailKey) {
            $this->nama_layanan->setFormValue(ConvertFromUtf8($val));
        }
    ...
    {
        global $CurrentForm;
        $this->nama_layanan->CurrentValue = ConvertToUtf8($this->nama_layanan->FormValue);
    }
