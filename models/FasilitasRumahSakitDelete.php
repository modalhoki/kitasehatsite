 ...
 * Page class
 */
class FasilitasRumahSakitDelete extends FasilitasRumahSakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FasilitasRumahSakitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("fasilitasrumahsakitlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("fasilitasrumahsakitlist"); // Return to list
                return;
            }
        }
