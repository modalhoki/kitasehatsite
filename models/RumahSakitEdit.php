 ...
 * Page class
 */
class RumahSakitEdit extends RumahSakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RumahSakitEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("fasilitas_rumah_sakit", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // daerah_id
            $this->daerah_id->setDbValueDef($rsnew, $this->daerah_id->CurrentValue, 0, $this->daerah_id->ReadOnly);
