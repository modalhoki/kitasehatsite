...
loadjs.ready("head", function () {
    ...
    fdokter_poliadd = currentForm = new ew.Form("fdokter_poliadd", "add");
    ...
    // Validate form
    fdokter_poliadd.validate = function () {
    ...
    // Form_CustomValidate
    fdokter_poliadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdokter_poliadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fdokter_poliadd.lists.dokter_id = <?= $Page->dokter_id->toClientList($Page) ?>;
    fdokter_poliadd.lists.fasilitas_rs_id = <?= $Page->fasilitas_rs_id->toClientList($Page) ?>;
    loadjs.done("fdokter_poliadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdokter_poliadd" id="fdokter_poliadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
