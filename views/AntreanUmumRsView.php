...
// Page object
$AntreanUmumRsView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fantrean_umum_rsview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fantrean_umum_rsview = currentForm = new ew.Form("fantrean_umum_rsview", "view");
    loadjs.done("fantrean_umum_rsview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<script>
if (!ew.vars.tables.antrean_umum_rs) ew.vars.tables.antrean_umum_rs = <?= JsonEncode(GetClientVar("tables", "antrean_umum_rs")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fantrean_umum_rsview" id="fantrean_umum_rsview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->nomor_antrean->Visible) { // nomor_antrean ?>
    <tr id="r_nomor_antrean">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_nomor_antrean"><?= $Page->nomor_antrean->caption() ?></span></td>
...
<?php if ($Page->waktu->Visible) { // waktu ?>
    <tr id="r_waktu">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_waktu"><?= $Page->waktu->caption() ?></span></td>
...
<?php if ($Page->pasien_id->Visible) { // pasien_id ?>
    <tr id="r_pasien_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_pasien_id"><?= $Page->pasien_id->caption() ?></span></td>
...
<?php if ($Page->fasilitas_id->Visible) { // fasilitas_id ?>
    <tr id="r_fasilitas_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_fasilitas_id"><?= $Page->fasilitas_id->caption() ?></span></td>
...
<?php if ($Page->rumah_sakit_id->Visible) { // rumah_sakit_id ?>
    <tr id="r_rumah_sakit_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_rumah_sakit_id"><?= $Page->rumah_sakit_id->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->keluhan_awal->Visible) { // keluhan_awal ?>
    <tr id="r_keluhan_awal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_keluhan_awal"><?= $Page->keluhan_awal->caption() ?></span></td>
...
<?php if ($Page->Petugas->Visible) { // Petugas ?>
    <tr id="r_Petugas">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_umum_rs_Petugas"><?= $Page->Petugas->caption() ?></span></td>
        <td data-name="Petugas" <?= $Page->Petugas->cellAttributes() ?>>
<span id="el_antrean_umum_rs_Petugas">
