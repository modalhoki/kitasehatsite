...
<?php if ($Page->rumah_sakit_id->Visible) { // rumah_sakit_id ?>
        <th data-name="rumah_sakit_id" class="<?= $Page->rumah_sakit_id->headerCellClass() ?>"><div id="elh_users_rumah_sakit_id" class="users_rumah_sakit_id"><?= $Page->renderSort($Page->rumah_sakit_id) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_users_rumah_sakit_id">
