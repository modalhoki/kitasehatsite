...
// Page object
$KontakDaruratAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fkontak_daruratadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fkontak_daruratadd = currentForm = new ew.Form("fkontak_daruratadd", "add");
    ...
    // Validate form
    fkontak_daruratadd.validate = function () {
    ...
    // Form_CustomValidate
    fkontak_daruratadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkontak_daruratadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fkontak_daruratadd.lists.pasien_id = <?= $Page->pasien_id->toClientList($Page) ?>;
    loadjs.done("fkontak_daruratadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkontak_daruratadd" id="fkontak_daruratadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
