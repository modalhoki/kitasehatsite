...
loadjs.ready("head", function () {
    ...
    fwebusers_rsadd = currentForm = new ew.Form("fwebusers_rsadd", "add");
    ...
    // Validate form
    fwebusers_rsadd.validate = function () {
    ...
    // Form_CustomValidate
    fwebusers_rsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fwebusers_rsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fwebusers_rsadd.lists.administrator_rumah_sakit = <?= $Page->administrator_rumah_sakit->toClientList($Page) ?>;
    loadjs.done("fwebusers_rsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fwebusers_rsadd" id="fwebusers_rsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
