...
// Page object
$AntreanUmumList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fantrean_umumlist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fantrean_umumlist = currentForm = new ew.Form("fantrean_umumlist", "list");
    fantrean_umumlist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fantrean_umumlist");
});
var fantrean_umumlistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    fantrean_umumlistsrch = currentSearchForm = new ew.Form("fantrean_umumlistsrch");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "antrean_umum")) ?>,
        fields = currentTable.fields;
    fantrean_umumlistsrch.addFields([
    ...
    // Set invalid fields
    $(function() {
        fantrean_umumlistsrch.setInvalid();
    });

    // Validate form
    fantrean_umumlistsrch.validate = function () {
    ...
    // Form_CustomValidate
    fantrean_umumlistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fantrean_umumlistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
    ...
    loadjs.done("fantrean_umumlistsrch");
});
</script>
<style>
...
<form name="fantrean_umumlistsrch" id="fantrean_umumlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fantrean_umumlistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<input type="hidden" name="z_pasien_id" id="z_pasien_id" value="=">
        ...
        <span id="el_antrean_umum_pasien_id" class="ew-search-field">
...
<input type="hidden" name="z_fasilitas_id" id="z_fasilitas_id" value="=">
        ...
        <span id="el_antrean_umum_fasilitas_id" class="ew-search-field">
<div class="input-group ew-lookup-list">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> antrean_umum">
<form name="fantrean_umumlist" id="fantrean_umumlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="antrean_umum">
<div id="gmp_antrean_umum" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit()) { ?>
<table id="tbl_antrean_umumlist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->nomor_antrean->Visible) { // nomor_antrean ?>
        <th data-name="nomor_antrean" class="<?= $Page->nomor_antrean->headerCellClass() ?>"><div id="elh_antrean_umum_nomor_antrean" class="antrean_umum_nomor_antrean"><?= $Page->renderSort($Page->nomor_antrean) ?></div></th>
<?php } ?>
<?php if ($Page->waktu->Visible) { // waktu ?>
        <th data-name="waktu" class="<?= $Page->waktu->headerCellClass() ?>"><div id="elh_antrean_umum_waktu" class="antrean_umum_waktu"><?= $Page->renderSort($Page->waktu) ?></div></th>
<?php } ?>
<?php if ($Page->pasien_id->Visible) { // pasien_id ?>
        <th data-name="pasien_id" class="<?= $Page->pasien_id->headerCellClass() ?>"><div id="elh_antrean_umum_pasien_id" class="antrean_umum_pasien_id"><?= $Page->renderSort($Page->pasien_id) ?></div></th>
<?php } ?>
<?php if ($Page->fasilitas_id->Visible) { // fasilitas_id ?>
        <th data-name="fasilitas_id" class="<?= $Page->fasilitas_id->headerCellClass() ?>"><div id="elh_antrean_umum_fasilitas_id" class="antrean_umum_fasilitas_id"><?= $Page->renderSort($Page->fasilitas_id) ?></div></th>
<?php } ?>
<?php if ($Page->rumah_sakit_id->Visible) { // rumah_sakit_id ?>
        <th data-name="rumah_sakit_id" class="<?= $Page->rumah_sakit_id->headerCellClass() ?>"><div id="elh_antrean_umum_rumah_sakit_id" class="antrean_umum_rumah_sakit_id"><?= $Page->renderSort($Page->rumah_sakit_id) ?></div></th>
<?php } ?>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_antrean_umum", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_antrean_umum_nomor_antrean">
...
<span id="el<?= $Page->RowCount ?>_antrean_umum_waktu">
...
<span id="el<?= $Page->RowCount ?>_antrean_umum_pasien_id">
...
<span id="el<?= $Page->RowCount ?>_antrean_umum_fasilitas_id">
...
<span id="el<?= $Page->RowCount ?>_antrean_umum_rumah_sakit_id">
