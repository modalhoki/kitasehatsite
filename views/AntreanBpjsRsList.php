...
<?php if ($Page->Petugas->Visible) { // Petugas ?>
        <th data-name="Petugas" class="<?= $Page->Petugas->headerCellClass() ?>"><div id="elh_antrean_bpjs_rs_Petugas" class="antrean_bpjs_rs_Petugas"><?= $Page->renderSort($Page->Petugas) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_antrean_bpjs_rs_Petugas">
