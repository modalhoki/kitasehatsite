...
<input type="<?= $Page->datetime->getInputTextType() ?>" data-table="audittrail" data-field="x_datetime" name="x_datetime" id="x_datetime" maxlength="19" placeholder="<?= HtmlEncode($Page->datetime->getPlaceHolder()) ?>" value="<?= $Page->datetime->EditValue ?>"<?= $Page->datetime->editAttributes() ?> aria-describedby="x_datetime_help">
