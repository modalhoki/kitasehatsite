...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_praktik_poli_id" class="praktik_poli_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_praktik_poli_id">
