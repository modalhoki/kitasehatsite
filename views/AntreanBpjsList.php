...
loadjs.ready("head", function () {
    ...
    fantrean_bpjslistsrch.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
<input type="hidden" name="z_status" id="z_status" value="=">
        ...
        <span id="el_antrean_bpjs_status" class="ew-search-field">
...
<?php if ($Page->webusers_id->Visible) { // webusers_id ?>
        <th data-name="webusers_id" class="<?= $Page->webusers_id->headerCellClass() ?>"><div id="elh_antrean_bpjs_webusers_id" class="antrean_bpjs_webusers_id"><?= $Page->renderSort($Page->webusers_id) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_antrean_bpjs_webusers_id">
