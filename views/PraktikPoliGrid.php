...
<input type="<?= $Grid->jam_praktik->getInputTextType() ?>" data-table="praktik_poli" data-field="x_jam_praktik" name="x<?= $Grid->RowIndex ?>_jam_praktik" id="x<?= $Grid->RowIndex ?>_jam_praktik" size="30" maxlength="13" placeholder="<?= HtmlEncode($Grid->jam_praktik->getPlaceHolder()) ?>" value="<?= $Grid->jam_praktik->EditValue ?>"<?= $Grid->jam_praktik->editAttributes() ?>>
