...
<?php if ($Page->keluhan_awal->Visible) { // keluhan_awal ?>
    <tr id="r_keluhan_awal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_bpjs_keluhan_awal"><?= $Page->keluhan_awal->caption() ?></span></td>
        <td data-name="keluhan_awal" <?= $Page->keluhan_awal->cellAttributes() ?>>
<span id="el_antrean_bpjs_keluhan_awal">
...
<?php if ($Page->webusers_id->Visible) { // webusers_id ?>
    <tr id="r_webusers_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_antrean_bpjs_webusers_id"><?= $Page->webusers_id->caption() ?></span></td>
