...
// Page object
$FasilitasRumahSakitList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var ffasilitas_rumah_sakitlist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    ffasilitas_rumah_sakitlist = currentForm = new ew.Form("ffasilitas_rumah_sakitlist", "list");
...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "rumah_sakit") {
    if ($Page->MasterRecordExists) {
        include_once "views/RumahSakitMaster.php";
    }
}
?>
<?php } ?>
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> fasilitas_rumah_sakit">
<form name="ffasilitas_rumah_sakitlist" id="ffasilitas_rumah_sakitlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="fasilitas_rumah_sakit">
<?php if ($Page->getCurrentMasterTable() == "rumah_sakit" && $Page->CurrentAction) { ?>
...
<table id="tbl_fasilitas_rumah_sakitlist" class="table ew-table"><!-- .ew-table -->
<thead>
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_fasilitas_rumah_sakit", "data-rowtype" => $Page->RowType]);
