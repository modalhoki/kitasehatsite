...
<input type="<?= $Page->waktu->getInputTextType() ?>" data-table="antrean_umum" data-field="x_waktu" name="x_waktu" id="x_waktu" placeholder="<?= HtmlEncode($Page->waktu->getPlaceHolder()) ?>" value="<?= $Page->waktu->EditValue ?>"<?= $Page->waktu->editAttributes() ?>>
...
loadjs.ready(["fantrean_umumsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fantrean_umumsearch", "x_waktu", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
