...
var fpraktik_poliadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpraktik_poliadd = currentForm = new ew.Form("fpraktik_poliadd", "add");
    ...
    // Validate form
    fpraktik_poliadd.validate = function () {
    ...
    // Form_CustomValidate
    fpraktik_poliadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
$Page->showMessage();
?>
<form name="fpraktik_poliadd" id="fpraktik_poliadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
