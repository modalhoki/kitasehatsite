...
loadjs.ready("head", function () {
    ...
    fwebusersadd = currentForm = new ew.Form("fwebusersadd", "add");
    ...
    // Validate form
    fwebusersadd.validate = function () {
    ...
    // Form_CustomValidate
    fwebusersadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fwebusersadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fwebusersadd" id="fwebusersadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
